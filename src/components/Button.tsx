...
export default function ({ onClick, text }: ButtonProps) {
	return (
		<button className='group relative flex h-[59px] cursor-pointer items-center overflow-hidden rounded-lg bg-green-600 select-none' onClick={onClick}>
